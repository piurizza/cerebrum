...
def test_graph_reflects_linked_notes(authenticated_client: TestClient) -> None:
    authenticated_client.put("/api/notes/a.md", content="See [B](b.md).")
    authenticated_client.put("/api/notes/b.md", content="content")

    response = authenticated_client.get("/api/graph")
...
def test_graph_includes_ghost_node_for_broken_link(
    authenticated_client: TestClient,
) -> None:
    authenticated_client.put("/api/notes/a.md", content="See [Missing](missing.md).")
...
def test_backlinks_endpoint_returns_linking_notes(
    authenticated_client: TestClient,
) -> None:
    ...
    response = authenticated_client.get("/api/notes/b.md/backlinks")
